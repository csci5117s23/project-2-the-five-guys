    ...
    if(trip && park){
      ...
      if(trip.itinerary){
        trip.itinerary.map(item => {
          ...
          itineraryListText += startDate.toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" }); + " - " + endDate.toLocaleDateString("en-US", { year: "numeric", month: "short", day: "numeric" }); + ": " + item.location + ", " + item.description + "\n"
        });
      }else{
